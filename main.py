...
# Arguments
parser = argparse.ArgumentParser(description='Training PPG2Mel VC model.')
parser.add_argument('--config', default='/mnt/nvme-data1/waris/repo/vq-bnf-translator/conf/translator_vq128.yaml',
                    type=str, 
